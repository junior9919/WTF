...
public class ShortVideoMessage extends Message {
	 ...
	 *            消息id，64位整型
	 */
	public ShortVideoMessage(String toUserName, String fromUserName, Timestamp createTime, String msgType, String mediaId, String thumbMediaId, long msgId) {
	 ...
	 *            消息id，64位整型
	 */
	public ShortVideoMessage(String toUserName, String fromUserName, long createTime, String msgType, String mediaId, String thumbMediaId, long msgId) {
		super(toUserName, fromUserName, createTime, msgType, msgId);
		setMediaId(mediaId);
		setThumbMediaId(thumbMediaId);
	}
